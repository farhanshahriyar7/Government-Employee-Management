...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      // Training and Foreign Information Tables
      domestic_trainings: {
        Row: {
          id: string
          user_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "domestic_trainings_user_id_fkey"
            columns: ["user_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          }
      ...
      foreign_trainings: {
        ...
        Relationships: [
          {
            foreignKeyName: "foreign_trainings_user_id_fkey"
            columns: ["user_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          }
      ...
      foreign_travels: {
        ...
        Relationships: [
          {
            foreignKeyName: "foreign_travels_user_id_fkey"
            columns: ["user_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          }
      ...
      foreign_postings: {
        ...
        Relationships: [
          {
            foreignKeyName: "foreign_postings_user_id_fkey"
            columns: ["user_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          }
      ...
      lien_deputations: {
        ...
        Relationships: [
          {
            foreignKeyName: "lien_deputations_user_id_fkey"
            columns: ["user_id"]
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          }
